...
if(p){long H=0,L=0;for(j=1000;j-->0;){e();while(u<v){H-=q[u]>>31;L++;d(q[u++]);}}return""+H*(L-H);}int W=t[X]/8,S=0;long A=1;for(k=1;W>0;k++){e();while(u<v){z=q[u++];if(z<0&(z&1023)==X&(S&1<<(j=z>>10&1023))<1){S|=1<<j;A*=k;W--;}d(z);}}return""+A;
}
